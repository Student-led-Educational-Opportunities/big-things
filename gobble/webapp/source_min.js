...
function webViewOpen(path) {
    try {
        ...
        html = html.replace("common.js", `https://cdn.jsdelivr.net/gh/Student-led-Educational-Opportunities/big-things@master/gobble/webapp/view_common.js`);
        html = html.replace("common.css", `https://cdn.jsdelivr.net/gh/Student-led-Educational-Opportunities/big-things@master/gobble/webapp/view_common.css`);
        var content = document.getElementById("webview_content");
