...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.gobble/version';Storage.PREFIX='com.martinmagni.gobble/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('https://leveldata.poki.io/fancade-5F39593BFC59C233','e5530aad-6c7e-47c4-a697-00bbe14b98f5');}
