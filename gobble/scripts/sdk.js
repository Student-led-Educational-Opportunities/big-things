...
(() => {
    ...
    function playFallbackVideo() {
        return new Promise((resolve) => {
            ...
            const ctaUrl = new URL(videoData.link);
            ctaUrl.searchParams.set('utm_source', parentDomain);
            ctaUrl.searchParams.set('utm_medium', 'embedded_game');
            ctaUrl.searchParams.set('utm_campaign', 'play_now');
